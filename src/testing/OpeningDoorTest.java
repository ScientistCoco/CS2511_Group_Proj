...
public class OpeningDoorTest {
	...
	public void testNoKey() {
		Board b3 =new Board();
		Door d3 = new Door(1, 1, b3, 1);
		Player p3 = new Player(0, 0, b3);
	...
	public void testCanDoorStatusAfterOpening() {
		Board b4 =new Board();
		Door d4 = new Door(1, 1, b4, 1);
		Inventory i4 = new Inventory();
		Key k4 = new Key(0, 0, b4, 1, i4);
		i4.addItem(k4);
		k4.openDoor(d4);
	...
	public void testKeyDisappearAfterOpeningDoor() {
		Board b5 =new Board();
		Door d5 = new Door(1, 1, b5, 1);
		Inventory i5 = new Inventory();
		Key k5 = new Key(0, 0, b5, 1, i5);
		i5.addItem(k5);
		k5.openDoor(d5);
