...
public class SwordTest {
	...
	public void TestDestroyEnemy() {
		...
		Sword s1 = new Sword(0, 0, b1, i1);
		i1.addItem(s1);
		Enemy e1 = new Enemy(1, 0, b1);
	...
	public void TestHitsRemain() {
		...
		Sword s2 = new Sword(0, 0, b2, i2);
		i2.addItem(s2);
		Enemy e2 = new Enemy(1, 0, b2);
	...
	public void TestSwordDisappearAfterFiveHits() {
		...
		Sword s3 = new Sword(0, 0, b3, i3);
		i3.addItem(s3);
		Enemy e3 = new Enemy(1, 0, b3);
